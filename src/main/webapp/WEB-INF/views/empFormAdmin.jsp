...
<body>
	<div class=bg-img>
		...
		<div class=block-center align="center">
			...
			<form:form action="saveEmpAdmin" method="post" modelAttribute="employee">
				<form:hidden path="emp_id" />
				
				<label for="eircodeID"> Eircode: </label>
				<input type="number" id="eircodeID" name="eircodeID"
					placeholder="0834567890" value=${employee.eircodeID} required>
				<br>
				
				<label for="hire_date"> Hire date: </label>
				<input type="date" id="hire_date" name="hire_date"
					min="2020-08-01" value= ${employee.hire_date} required>
				<br>
